...
const HoverElement = ({ title }) => {
    return (
        <div className="fixed lg:ml-[95px] mb-6 rounded px-1 whitespace-nowrap cursor group-hover:block opacity-90 w-0 h-0 group-hover:w-12 group-hover:h-auto invisible group-hover:visible">
            <div className="text-[12px] font-medium w-auto absolute border-[1px] border-stone-600 bg-stone-700 px-2 py-0.5 rounded-md text-white group-hover:opacity-100 opacity-0 transition delay-0 group-hover:delay-300">
                {title}
            </div>
        </div>
    );
